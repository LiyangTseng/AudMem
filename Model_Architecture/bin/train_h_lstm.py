...
class Solver(BaseSolver):
    ...
    def exec(self):
        ...
        for epoch in range(self.max_epoch):
            ...
            for i, data in enumerate(self.train_loader):
                ...
                reg_loss = self.reg_loss_func(pred_scores, lab_scores.reshape(-1, 1))
            ...
            self.write_log('loss', {'reg_loss/train': reg_loss})
            self.write_log('loss', {'rank_loss/train': rank_loss})
            self.write_log('loss', {'total_loss/train': total_loss})
    ...
    def validate(self):
        ...
        if epoch_valid_total_loss < self.best_valid_loss:
            ...
            # if self.step > 1:
            if self.epoch > 1:
                self.save_checkpoint('h_lstm_{}.pth'.format(
